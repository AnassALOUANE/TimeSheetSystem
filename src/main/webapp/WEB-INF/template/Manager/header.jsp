 ...
 <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav">
                            <li class="active">
                                <a href="${pageContext.request.contextPath}/manager/"><spring:message code="application.timesheet" /></a>
                            </li>
                            <li class="dropdown">
                                <a href="${pageContext.request.contextPath}/employee/" ><spring:message code="application.my.timesheet" /> </a>
                            </li>
                            <li class="dropdown">
                                <a href="${pageContext.request.contextPath}/manager/approve"><spring:message code="application.timesheet.approve" /> </a>
                            </li>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
