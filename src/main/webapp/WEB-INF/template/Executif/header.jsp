 ...
 <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav">
                            <li class="active">
                                <a href="${pageContext.request.contextPath}/executif/"><spring:message code="application.executif.staff.hours" /></a>
                            </li>
                            <li class="dropdown">
                                <a href="${pageContext.request.contextPath}/executif/overallSummary/" ><spring:message code="application.executif.overall.summary" /> </a>
                            </li>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
