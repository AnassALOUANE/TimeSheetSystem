                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><spring:message code="application.timesheet.list.paid"/> </div>
                            </div>
                                ...
                                <div class="span12">
                                    ...
                                    <c:choose>
                                         <c:when test="${not empty timesheets}">
                                                 ...
                                                 <form method="post"  action="${pageContext.request.contextPath}/comptable/paid">
						               ...
						               <tbody>
                                                                <c:forEach items="${timesheets}" var="t" >  
                                                                    <tr>
                                                                      ...
                                                                      <td><span class="badge badge-important">${t.totalHours}</span></td>
...
<!--                                                                               <span style="margin:3px; vertical-align: middle;"> <input type="radio" name="ap" value="Yes ${t.id_timesheet}" /> Yes </span>
                                                    ...
                                                    <div class="form-actions">
                                                      <button type="submit" class="btn btn-primary"><spring:message code="application.payment.notpaid"/> </button>
