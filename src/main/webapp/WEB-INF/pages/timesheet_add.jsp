                    ...
                    <div class="row-fluid">
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">  <spring:message code="application.timesheet.new"/> </div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
        
                                    <form:form  modelAttribute="timesheet" method="post" action="${pageContext.request.contextPath}/timesheet/add" class="form-horizontal">
                                      ...
                                      <fieldset>
                                        ...
                                        <div class="form-actions">
                                          <button type="submit" class="btn btn-primary"><spring:message code="application.crud.add"/> </button>
