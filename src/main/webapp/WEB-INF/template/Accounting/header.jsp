 ...
 <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav">
                            <li class="active">
                                <a href="${pageContext.request.contextPath}/comptable/"><spring:message code="application.payment" /></a>
                            </li>
                            <li class="dropdown">
                                <a href="${pageContext.request.contextPath}/comptable/paid/" ><spring:message code="application.paid" /> </a>
                            </li>
                            <li class="dropdown">
